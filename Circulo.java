...
public class Circulo extends Figura2D {
   ...
   public Circulo (int x, int y, int r) {
      this.centroX = x;this.centroY = y;this.radio = r;this.colorBorde = null;this.colorRelleno = null;}
   ...
   public Circulo (int x, int y, int r, Color borde, Color relleno) {
      this.centroX = x;this.centroY = y;this.radio = r;this.colorBorde = borde;this.colorRelleno = relleno;}
